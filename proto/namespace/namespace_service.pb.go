...
var file_namespace_service_proto_rawDesc = []byte{
	...
	0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xbb, 0x02, 0x0a, 0x10, 0x4e, 0x61,
	...
	0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x1a, 0x10, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f,
	0x6e, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2b, 0x0a, 0x05, 0x4c, 0x69,
	0x73, 0x74, 0x73, 0x12, 0x0f, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x11, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x73, 0x42, 0x0d, 0x5a, 0x0b, 0x70, 0x72, 0x6f, 0x74, 0x6f,
...
var file_namespace_service_proto_depIdxs = []int32{
	...
	1, // 5: namespace.NamespaceService.Lists:input_type -> common.Request
	2, // 6: namespace.NamespaceService.Create:output_type -> common.Response
	2, // 7: namespace.NamespaceService.Delete:output_type -> common.Response
	2, // 8: namespace.NamespaceService.DeleteById:output_type -> common.Response
	2, // 9: namespace.NamespaceService.Update:output_type -> common.Response
	2, // 10: namespace.NamespaceService.Find:output_type -> common.Response
	3, // 11: namespace.NamespaceService.Lists:output_type -> common.Responses
...
func (c *namespaceServiceClient) Lists(ctx context.Context, in *common.Request, opts ...grpc.CallOption) (*common.Responses, error) {
...
func _NamespaceService_Lists_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NamespaceServiceServer).Lists(ctx, req.(*common.Request))
	}
	return interceptor(ctx, in, info, handler)
}
